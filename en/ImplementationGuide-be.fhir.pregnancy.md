# Resource Belgian Pregnancy Implementation Guide
...
```json
{
  ...
  "id" : "be.fhir.pregnancy",
  "language" : "en",
  "url" : "https://www.ehealth.fgov.be/standards/fhir/pregnancy/ImplementationGuide/be.fhir.pregnancy",
  "version" : "0.1.0",
  "name" : "BeFhirPregnancy",
  "title" : "Belgian Pregnancy Implementation Guide",
  "status" : "draft",
  ...
  "description" : "Belgian FHIR Implementation Guide for pregnancy data. Initial scope: a small set of pregnancy-status data — pregnancy confirmation, expected due date, expected number of children, and pregnancy duration. Vitalink FHIR and MAGDA are one implementation, collecting this data from EMR/hospital systems and making it available to government agencies (notably VUTG for Groeipakket entitlement), to citizen platforms (mijngezondheid.be, mijnburgerprofiel.be) and to caregivers. The IG is designed to grow incrementally, with administrative and clinical pregnancy data added by other stakeholders and projects (eBirth, Born in Belgium, Zoet Zwanger, PALS, AZ Turnhout moeder/kind boekje, etc.) over time.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://www.ehealth.fgov.be/standards/fhir/pregnancy/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "Observation/ex-pregnancy-status-contained"
      },
      "name" : "ex-pregnancy-status-contained",
      "exampleCanonical" : "https://www.ehealth.fgov.be/standards/fhir/pregnancy/StructureDefinition/be-pregnancy-status"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/be-pregnancy-condition"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Condition/ex-pregnancy-condition"
      },
      "name" : "Pregnancy as a Condition (clinical episode)",
      ...
      "exampleCanonical" : "https://www.ehealth.fgov.be/standards/fhir/pregnancy/StructureDefinition/be-pregnancy-condition"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/be-pregnancy-status"
      },
      "name" : "Pregnancy Status (administrative)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/PregnancyStatusDataSet"
      },
      "name" : "Pregnancy Status Model",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/be-pregnancy-status-vs"
      },
      "name" : "Pregnancy status value set (BE)",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "pregnancy-status.html"
        }],
        "nameUrl" : "pregnancy-status.html",
